...
public class ComparisonAPI {
    ...
    @Operation(description = "Авторизация: ВСЕ", summary = "Метод для добовления гаджетов в сравнении или удалении")
    ...
    @Operation(description = "Метод показывает гаджетов в сравнении", summary = "Метод показывает гаджетов в сравнении")
    @GetMapping("/list-сompare")
    public List<ListComparisonResponse> listCompare() {
        return userService.seeComparison();
    }

    @Operation(description = "Метод для просмотра различий", summary = "Метод для просмотра различий")
    @GetMapping("/compare")
    ...
    @Operation(description = "Метод для удаление одного гаджета в сравнении", summary = "Метод для удаление одного гаджета в сравнении")
    ...
    @Operation(description = "Метод для удаление всех гаджетов в сравнении", summary = "Метод для удаление всех гаджетов в сравнении")
    @DeleteMapping("/clear")
