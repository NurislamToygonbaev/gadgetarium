...
public class DiscountApi {
    ...
    @PostMapping
    public DiscountResponse create(@RequestParam @NotNull List<Long> gadgetId, @RequestBody @Valid DiscountRequest discountRequest){
        return discountService.create(gadgetId, discountRequest);
    }
